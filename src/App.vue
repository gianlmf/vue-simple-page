...
<header>
  <nav>
    <div class="flex justify-center">
      <div class="w-full max-w-screen-xl px-10 py-2">
          <h2 class="my-8 flex flex-row flex-nowrap items-center">
            <span class="block flex-grow border-t border-black"></span>
            <span class="mx-4 block flex-none bg-black px-4 py-2.5 text-xs font-medium uppercase leading-none text-white"> Simple Tea </span>
            <span class="block flex-grow border-t border-black"></span>
          </h2>
      </div>
    </div>
    ...
    <div>
        ...
        <RouterLink to="/tea">Tea</RouterLink>
  ...
  <footer class="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">  
